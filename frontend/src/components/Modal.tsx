    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true">
      ...
      <div className="relative card w-full max-w-lg bg-white p-6 sm:p-8 max-h-[85vh] overflow-y-auto rounded-3xl">
        ...
        <button
          onClick={onClose}
          aria-label="Close"
          className="absolute top-3 right-3 w-9 h-9 rounded-full bg-blush text-rose-deep flex items-center justify-center hover:bg-rose hover:text-white transition-colors"
        >
          <X size={18} />
        </button>
        {children}
