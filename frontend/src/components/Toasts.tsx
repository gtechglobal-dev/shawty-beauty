      ...
      {createPortal(
        <div className="fixed inset-x-0 bottom-[30vh] z-[70] flex flex-col items-center gap-2 px-4 pointer-events-none">
          {toasts.map((t) => (
            <div
              key={t.id}
              className={`pointer-events-auto flex items-center gap-2.5 px-4 py-2.5 rounded-xl border shadow-lg shadow-[#321d24]/20 bg-white text-[#321d24] text-sm min-w-[260px] max-w-md ${
            ...
            >
              ...
              <button
                ...
                className="shrink-0 text-muted hover:text-[#321d24] transition-colors"
                aria-label="Dismiss"
              >
                <X size={16} />
              </button>
