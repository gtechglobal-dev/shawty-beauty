...
export default function Footer() {
  return (
    <footer className="silk-dark relative text-cream mt-20">
      ...
      <div className="container relative z-10 section-pad grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center sm:text-left">
        <div className="sm:col-span-2">
          <div className="flex items-center justify-center sm:justify-start gap-3 mb-4">
            <span className="relative">
              <span className="w-9 h-9 rounded-full bg-gradient-to-br from-rose to-rose-deep flex items-center justify-center text-white font-display text-lg font-bold shadow-[0_6px_14px_-6px_rgba(0,0,0,0.5)]">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-muted">
            ...
            <li><Link to="/sponsor" className="hover:text-white transition-colors">Our Sponsors</Link></li>
            <li><Link to="/contact" className="hover:text-white transition-colors">Contact</Link></li>
            <li><Link to="/diary" className="hover:text-white transition-colors">Shawty&rsquo;s Diary</Link></li>
          </ul>
        </div>
